function notificaUsuario(doc, tipo)
{
	...
	// Remove o is-valid do campo caso o usuÃ¡rio sejÃ¡ notificado que o cpf ou cnpj seja invalido.
	if(tipo == "CPF")
	{
	...
	{
		alert("O CNPJ digitado Ã© invalido!");
...
function validarCPF(id) {
	...
	if(cpf == '')
	{
		return false; // NÃ£o retorna mensagem de erro pois o HTML validarÃ¡ se o campo estÃ¡ em branco.
	}	
	...
	doc_cpf.className += " is-valid"; // Marca o campo de verde para informar que Ã© vÃ¡lido.
	return true; // Retorna TRUE quando o CPF for vÃ¡lido
}
...
function validarCNPJ(id) {
	...
	doc_cnpj.className += " is-valid"; // Marca o campo de verde para informar que Ã© vÃ¡lido.
	return true; // Retorna TRUE quando o CNPJ for vÃ¡lido
}