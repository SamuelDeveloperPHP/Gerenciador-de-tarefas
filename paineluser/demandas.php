                                                ...
                                                <div class="row titleacc">
                                                    ...
                                                    <div class="col-lg-2" style="display: flex;justify-content: flex-end;">
                                                        ...
                                                        <a type="button" style="color:#0d6efd" class="btn style-action" href="cadastrardemandas.php?funcao=editar&id=<?php echo $vistoria['id']; ?>">
                                                            ...
                                                            <a type="button" style="color:#dc3545" class="btn style-action" onclick="return confirm('Deseja realmente excluir a demanda <?php echo $vistoria['id']; ?> ?');" href="?acao=deletar&id=<?php echo $vistoria['id']; ?>">
                                                ...
                                                <div class="headermodal">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 mobile" style="text-align: right;">
                                                            <span style="padding: 5px;background-color:#E0FBE0;border-radius:30px;font-size:12px;padding-left: 15px;padding-right: 15px;"><strong>Data de Criação:</strong> <?php echo $vistoria['data_cadastro']; ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="headermodal" style="display: flex;justify-content: flex-end;">
                            ...
                            <span style="margin-right:20px;background-color:#E0FBE0;border-radius:30px;font-size:12px;padding-right: 15px;padding-left: 15px;"><strong>Data de Criação:</strong> <?php echo $data_cadastro ?></span>
                        </div>
                        ...
                        <div class="overflow" <?php if ($_GET['funcao'] == 'ver') {
                                                    echo 'style="height:72% !important;"';
                                                } ?>>
                            <?php
                            ...
                            ?>
                                ...
                                <div class="comment">
                                    ...
                                    <span style="float: right;font-size: 12px;background: #E0FBE0;border-radius:30px;padding:5px;padding-left: 15px;padding-right: 15px;"><strong>Data comentário:</strong> <?php echo $res['data_comentario']; ?></span><br>
                                    ...
                                    <span style="float:right">
                                        <div class="col-lg-2" style="display: flex;">
                                            ...
                                            <a type="button" style="color:#dc3545" class="btn style-action" onclick="return confirm('Deseja realmente excluir o comentário <?php echo $res['id']; ?> ?');" href="?acao=deletarhis&id=<?php echo $res['id']; ?>">
                                                <i class="fas fa-trash" aria-hidden="true"></i></a>
