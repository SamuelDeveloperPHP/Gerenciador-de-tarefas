                                            ...
                                            <form action="" method="post" enctype="multipart/form-data">
                                                <div class="row" style="display: flex;align-items: center;">
                                                        ...
                                                        <div class="col-lg-2">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group" style="height: 150px;">
                                                                    ...
                                                                    <!--    <input type="file" class="custom-file-input" accept="image/*" id="userfile" name="userfile">-->
                                                                    <!--    <label class="custom-file-label" for="exampleInputFile">Escolher arquivo</label>-->
                                                                    <!--</div>-->
                                                                    <!--<div class="input-group mb-3">-->
                                                                    <!--  <label class="input-group-text" for="inputGroupFile01" style="height: 150px;">Upload</label>-->
                                                                    <!--  <input style="height: 150px;margin-bottom: 0px !important;" type="file" id="userfile" name="userfile" class="form-control">-->
                                                                    <!--</div>-->
                                                    ...
                                                    <p>
                                                        ...
                                                        //     $cadastro = $acoes->cadastrar_demanda();
                                                        ...
                                                        <?php
                                                                ...
                                                                if(@$_GET['funcao'] == 'editar') {
                                                                        ...
                                                                        $cadastro = $acoes->atualizar_demandas(
                                                                            $id_demanda,$titulo, $modulo, $data, $prioridade, $descricao, $regra_negocio, $file_name
                                                                        );
                                                                        ...
                                                                        $cadastro = $acoes->cadastrar_demandas2(
                                                                            $titulo, $modulo, $data, $prioridade, $descricao, $regra_negocio, $file_name
                                                                        );
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="input-group mb-3">
                                                                      <!--<label class="input-group-text" for="inputGroupFile01" style="height: 33px;">Upload</label>-->
                                                                      <div class="upload">
