...
if (!empty($_GET['acao']) && $_GET['acao'] == 'deletar' && $_GET['id'] > 0) {
    ...
    $acoes->deletarModulo($id_cliente);
...
if (!empty($_GET['busca'])) {
    ...
    $listarVistoriasPage = $acoes->listarModulos($inicio, $registrosPorPagina);
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h6 class="m-0 text-dark" style="font-size:24px"> Cadastro de módulos</h6>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                                        ...
                                        <div class="col-lg-12 text-right">
                                            <form action="" method="post" enctype="multipart/form-data">
                                                        <div class="row" style="display: flex;align-items: center;">
                                                            <div class="col-lg-6" style="padding-left: 0;padding-right: 12.5px;">
                                                                <div class="form-group"  style="margin-bottom:0px">
                                                                    <input type="hidden" class="form-control cnpj" placeholder="Nome do módulo" id="id_modulo" name="id_modulo" value="<?php echo $id_modulo ?>" required="">
                                                                    <input type="text" class="form-control cnpj" placeholder="Nome do módulo" id="name" name="name" value="<?php echo $name ?>" required="">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4" style="    padding-left: 12.5px;padding-right: 12.5px;">
                                                                <div class="form-group"  style="margin-bottom:0px">
                                                                     <select name="sistema_mod" id="sistema_mod" class="form-select" aria-label="Default select example">
                                                                        ...
                                                                        <option value="<?php echo $sistema_mod ?>"><?php echo $code1 ?> (Atual)</option>
                                                            ...
                                                            <div class="col-lg-2" style="text-align: left;padding-right: 0;padding-left: 12.5px;">
                                                                ...
                                                                if ($_GET['acao'] == 'editar') {
                                                                        ...
                                                                        $id_modulo = htmlspecialchars($_POST['id_modulo']);
                                                                        $name = htmlspecialchars($_POST['name']);
                                                                        $sistema_mod = htmlspecialchars($_POST['sistema_mod']);
    
    
                                                                        $cadastro = $acoes->atualizar_modulo(
                                                                            $id_modulo,
                                                                            $name,
                                                                            $sistema_mod
                                                                        );
                                                                        ...
                                                                        if ($cadastro) {
                                                                            echo '<script type="text/javascript">toastr.success("Módulo atualizado com sucesso.")</script>';
                                                                            echo "<script>window.location.href = 'cadastromodulos.php';</script>";
                                                                        }
                                                                    }
                                                                        ...
                                                                        $cadastro = $acoes->cadastrar_modulo(
                                                                            $name,
                                                                            $sistema_mod
                                                                        );
    
                                                                        if ($cadastro) {
                                                                            echo '<script type="text/javascript">toastr.success("Módulo cadastrado com sucesso.")</script>';
                                                                        }
                                                                    }
                                                                ...
                                                                <button type="submit" style="width:100%" name="cadastrar_plano" class="btn btn-success salvar">
                                            ...
                                            <div class="row rounded" style="height:65px;border-radius:10px;border: 1px solid #EAEAEA; margin-bottom:10px">
                                                ...
                                                <div class="col-lg-2" style="display: flex;align-items: center;justify-content: flex-end;">
                                                    <div class="form-check form-switch">
                                                                ...
                                                                <a type="button" style="color:#dc3545;padding-right: 30px;" class="btn style-action" 
                                                                onclick="return confirm('Deseja realmente excluir o módulo <?php echo $vistoria['id']; ?> ?');" href="?acao=deletar&id=<?php echo $vistoria['id']; ?>">
