...
if (!empty($_GET['busca'])) {
    $busca = $_GET['busca'];
    $listarVistoriasPage = $acoes->buscarVistoriasPaginate4($busca, $inicio, $registrosPorPagina);
    $totalDeRegistros = count($listarVistoriasPage);
} else {
    $listarVistoriasPage = $acoes->listarEmpresas($inicio, $registrosPorPagina, $id);
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body no-print">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="cadastroempresa.php" class="btn btn-info"><i class="fas fa-plus-circle"></i> Nova Empresa</a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-hover text-nowrap table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><?php echo $vistoria['id_empresa']; ?></td>
                                                <td colspan="2"><?php echo $vistoria['CNPJ']; ?></td>
                                                <td><?php echo $vistoria['xNome']; ?></td>
                                                <td><?php echo $vistoria['xFant']; ?></td>
                                                <td><?php echo $vistoria['email']; ?></td>
                                                <td style="width:50px;">
